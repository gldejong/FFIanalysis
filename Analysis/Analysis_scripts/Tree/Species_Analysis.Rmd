...
Combining years 1990, 1991, 1992 - SAGUARO SPECIFIC
...
ggsave("C:/Users/edeegan/OneDrive - DOI/FFIanalysis/Analysis/PSME_Plots/PSME_species_allsizes.png", width=7, height=5)
```

### Species Composition Pie Chart by Size Class
...
\*recommended to add tags (total trees recorded) in powerpoint or image edited software after
...
print(my_tag)
#saving plot - CHANGE TITLE 
ggsave("C:/Users/edeegan/OneDrive - DOI/FFIanalysis/Analysis/PSME_Plots/PSME_species_by_size.png", width=15, height=8)
```
