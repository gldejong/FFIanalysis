...
knitr::opts_knit$set(root.dir ="C:/Users/edeegan/OneDrive - DOI/FFIanalysis/Analysis/" )
```
...
-   Read in fuel loading report from FFI reports and analysis section - must change to location of report on users computer!
-   Format date column
...
### Pre fire fuels versus post fire fuels

```{r}

fuels_prevpost <- fuels_factor2 %>% filter(year!='2003' & year!='2004'& year!='2013'& year!='1992'& year!='1997')
...
ggsave('PSME_Plots/Fuel_Loading_prevpost.png')
```
...
ggsave('PSME_Plots/Fuel_Loading_prevpost_scaled.png')
```
